    ...
    getLimitAmountSwap(poolPairData, swapType) {
        ...
        if (swapType === exports.SwapTypes.SwapExactIn) {
            if (linearPoolPairData.pairType === PairTypes$1.MainTokenToBpt) {
                ...
                // Limit is amount of BPT in for pool balance of tokenOut
                const limit = _calcBptInPerWrappedOut(bnum(linearPoolPairData.balanceOutScaled.toString()), bnum(linearPoolPairData.mainBalanceScaled.toString()), bnum(linearPoolPairData.wrappedBalanceScaled.toString()), bnum(linearPoolPairData.bptBalanceScaled.toString()), {
...
const optimizeSwapAmounts = (paths, swapType, totalSwapAmount, initialSwapAmounts, highestLimitAmounts, inputDecimals, outputDecimals, initialNumPaths, maxPools, costReturnToken) => {
    ...
    let bestTotalReturnConsideringFees = swapType === exports.SwapTypes.SwapExactIn ? INFINITY$1.times(-1) : INFINITY$1;
    let bestSwapAmounts = [];
    let bestPaths = [];
...
const MULTIADDR = {
    1: '0x653f3e6c7e2ae666c22e063d87a012c2f13ea416',
    ...
    43114: '0x5f031af1264ebcDf5abEE25C39793fF992fc2629',
};
const VAULTADDR = {
    1: '0xad68ea482860cd7077a5D0684313dD3a9BC70fbB',
    ...
    43114: '0xB50E0B4bdD373F1CD56c11D1784bF8C522dE5309',
};
...
function setWrappedInfo(swapInfo, swapType, wrappedInfo, chainId) {
    ...
    if (wrappedInfo.tokenIn.wrapType === WrapTypes.ETH ||
        ...
        swapInfo.tokenAddresses = swapInfo.tokenAddresses.map((addr) => isSameAddress(addr, WETHADDR[chainId]) ? constants.AddressZero : addr);
    }
...
class Multicaller {
    ...
    execute(from = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            results.forEach((result, i) => lodash_set(obj, this.paths[i], result.length > 1 ? result : result[0]));
            this.calls = [];
            this.paths = [];
            return obj;
        });
    ...
    executeMulticall() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [, res] = yield multi.aggregate(this.calls.map(([address, functionName, params]) => [
                address,
...
function getOnChainBalances(subgraphPoolsOriginal, multiAddress, vaultAddress, provider) {
    return __awaiter(this, void 0, void 0, function* () {
...
class PoolCacher {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (this.poolsUrl !== null) {
                    this.pools = yield fetchSubgraphPools(this.poolsUrl, this.chainId);
                }
    ...
    fetchOnChainBalances(subgraphPools, isOnChain = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const onChainPools = yield getOnChainBalances(subgraphPools, MULTIADDR[this.chainId], VAULTADDR[this.chainId], this.provider);
            return onChainPools;
        });
    }
}
...
*/
function getLinearStaBal3Paths(tokenIn, tokenOut, poolsAllDict, poolsFilteredDict, chainId) {
    ...
    // If both tokenIn and tokenOut belong to linear pools
        ...
        if (!wethStaBal3Pool)
            return pathsUsingLinear;
        const wethTokenOutPath = getMostLiquidPath([staBal3Pool.address, WETHADDR[chainId], tokenOut], 1, [wethStaBal3Pool], poolsFilteredDict, exports.SwapPairType.HopOut);
        ...
        if (!wethStaBal3Pool)
            return pathsUsingLinear;
        const tokenInWethPath = getMostLiquidPath([tokenIn, WETHADDR[chainId], staBal3Pool.address], 0, [wethStaBal3Pool], poolsFilteredDict, exports.SwapPairType.HopIn);
...
*/
function getPathsUsingStaBalPool(tokenIn, tokenOut, poolsAll, poolsFiltered, chainId) {
...
class RouteProposer {
     ...
     */
    getCandidatePaths(tokenIn, tokenOut, swapType, pools, swapOptions, chainId) {
        if (pools.length === 0)
            return [];
        ...
        const pathsUsingLinear = getLinearStaBal3Paths(tokenIn, tokenOut, poolsAllDict, poolsFilteredDict, chainId);
        const pathsUsingStaBal = getPathsUsingStaBalPool(tokenIn, tokenOut, poolsAllDict, poolsFilteredDict, chainId);
...
function getTokenPriceInNativeAssetFromSubgraph(tokenAddress, wrappedNativeAssetAddress, subgraphUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        const latestTokenPrice = yield fetchSubgraphLatestTokenPrice(tokenAddress, wrappedNativeAssetAddress, subgraphUrl);
        if (!latestTokenPrice) {
...
function fetchSubgraphLatestTokenPrice(tokenAddress, wrappedNativeAssetAddress, subgraphUrl) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const query = `
        {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const ethPerToken = this.subgraphUrl
                    ? yield getTokenPriceInNativeAssetFromSubgraph(tokenAddress, WETHADDR[this.chainId].toLowerCase(), this.subgraphUrl)
                    : yield getTokenPriceInNativeAsset(this.chainId, tokenAddress);
...
class SOR {
    ...
    constructor(provider, chainId, subgraphUrl, initialPools = []) {
        ...
        this.poolCacher = new PoolCacher(provider, chainId, subgraphUrl, initialPools);
    ...
    getSwaps(tokenIn, tokenOut, swapType, swapAmount, swapOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const wrappedInfo = yield getWrappedInfo(this.provider, swapType, tokenIn, tokenOut, this.chainId, bignumber.BigNumber.from(swapAmount));
            let swapInfo;
            if (isLidoStableSwap(this.chainId, tokenIn, tokenOut)) {
                swapInfo = yield getLidoStaticSwaps(filteredPools, this.chainId, wrappedInfo.tokenIn.addressForSwaps, wrappedInfo.tokenOut.addressForSwaps, swapType, wrappedInfo.swapAmountForSwaps, this.provider);
            }
            else {
            ...
            if (swapInfo.returnAmount.isZero())
                return swapInfo;
            swapInfo = setWrappedInfo(swapInfo, swapType, wrappedInfo, this.chainId);
            return swapInfo;
        });
    }
    /**
    ...
    processSwaps(tokenIn, tokenOut, swapType, swapAmount, pools, swapOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            if (pools.length === 0)
                return cloneDeep(EMPTY_SWAPINFO);
            const paths = this.routeProposer.getCandidatePaths(tokenIn, tokenOut, swapType, pools, swapOptions, this.chainId);
            if (paths.length == 0)
                return cloneDeep(EMPTY_SWAPINFO);
